...
class Command:
    ...
    def createList(self, debug, current_level, client_nb, reply):
        ...
        for i in range(count):
            if i < len(lst):
                ...
                result_dict[i] = []
        self.analysis.analyse_cases(result_dict, debug, lambda x:None, self.getLevel(), client_nb, self.getTeam(),reply)
        return result_dict
